...
The PATH changes only apply to new windows. Open a fresh PowerShell:
...
This produces:
```
Deployed ACT policy to 4 Go2s. 67% → 89% at 8cm.
[go2] [lerobot] [act policy] [imitation learning]
```
